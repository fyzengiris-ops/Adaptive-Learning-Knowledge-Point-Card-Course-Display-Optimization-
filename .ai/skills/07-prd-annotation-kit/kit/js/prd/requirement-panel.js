...
(function (global) {
  ...
  function registryForCurrentRoute() {
    if (global.RequirementUtils && global.RequirementUtils.getRegistryForHash) {
      return global.RequirementUtils.getRegistryForHash();
    }
    return null;
  }
  ...
  function buildDetailHtml(requirement) {
      ...
      var items = visibleItems
        .map(function (entry, idx) {
          return (
            ...
            "." +
            (idx + 1) +
            '</span><span data-edit-field="item" data-edit-section="' +
            sectionIdx +
            '" data-edit-item="' +
            entry.itemIdx +
            '" title="双击编辑">' +
        ...
        .join("");
      htmlParts.push(
        '<section class="prd-logic-section"><h4 data-edit-field="sectionTitle" data-edit-section="' +
          sectionIdx +
          '" title="双击编辑标题">' +
    ...
    if (!html) {
      html = '<p class="prd-detail-empty">暂无业务逻辑说明</p>';
    }
  ...
  function renderDetail(requirement) {
    ...
    detailEl.innerHTML =
      ...
      "</div>" +
      '<div class="prd-detail-title" data-edit-field="title" title="双击编辑标题">' +
  ...
  function bindPanelEvents() {
    ...
    if (detailEl && global.RequirementWriteback && global.RequirementWriteback.bindDelegatedEdit) {
      global.RequirementWriteback.bindDelegatedEdit(detailEl, {
        getRequirement: function () {
          return selectedId && global.RequirementUtils
            ? global.RequirementUtils.getRequirementById(selectedId)
            : null;
        },
