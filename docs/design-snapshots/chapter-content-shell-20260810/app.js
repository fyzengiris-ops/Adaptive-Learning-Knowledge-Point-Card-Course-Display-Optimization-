(function () {
  ...
  if (chapterSplit) {
    ...
    const papersTitle = document.querySelector("#chapter-papers-title .papers-title-text");
    ...
    switchChapterType = function (key) {
      ...
      if (papersTitle) papersTitle.textContent = meta.title;
