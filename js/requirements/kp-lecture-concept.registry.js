    ...
    requirements: [
      ...
      },
      {
        ...
        logicSections: [
          {
            ...
            items: [
              ...
              "该条要点无图时不占位。",
              "【8.11需求评审后补充】当只有一张图片的时候，整张图片满屏显示；当有两张图片的时候或者是图片数量为双数的时候，每两张图片在同行等比例显示；若是三张及以上的奇数图片张数，同理，每两张图片同行等比例显示，最后一张奇数图片换行居中显示。",
            ],
          },
          {
            title: "操作说明",
        ...
        acceptance: [
          ...
          "无图要点不出现空白图位。",
          "点击图片可放大，关闭后回到原页。",
          "1 张图满宽展示；偶数张每行 2 张等比例；奇数张（≥3）前序每行 2 张，末张换行居中。",
        ],
        source: {
          decisionFile: "docs/prd-workflow/decisions/kp-lecture-concept.decision.md",
          decisionObject: "要点配图",
