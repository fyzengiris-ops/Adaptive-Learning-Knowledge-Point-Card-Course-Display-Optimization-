      ...
      },
      {
        ...
        logicSections: [
          ...
          },
          {
            title: "异常情况处理",
            items: [
              "未配置典型例题时，例题区仍展示「典型例题」标签，下方展示缺省图和提示文案「更新中~」。",
            ],
          },
        ],
        acceptance: [
          ...
          "一考点仅展示 1 道典型例题。",
          "未配置典型例题时，展开后可见「典型例题」标签、缺省图与文案「更新中~」。",
        ],
        source: {
          decisionFile: "docs/prd-workflow/decisions/kp-lecture-exam.decision.md",
        ...
        logicSections: [
          {
            ...
            items: [
              "「典型例题」标签下方展示例题题干。",
              "有典型例题时题干必有，不做题干空占位。",
              "未配置典型例题时，不展示空题干，例题内容区展示缺省图和提示文案「更新中~」。",
      ...
      },
      {
        ...
        logicSections: [
          ...
          },
          {
            title: "异常情况处理",
            items: [
              "解题步骤与解题要点均未配置时，仍显示「解析」开关，不因内容为空而隐藏。",
            ],
          },
        ],
        acceptance: [
